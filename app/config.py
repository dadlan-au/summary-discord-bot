...
class AppSettings(BaseSettings):
    ...
    RENDER_TIX_TEMPLATE_SCROLL_SCRIPT: str
    RENDER_TIX_DELAY_INTERVAL_MS: int
    RENDER_CONTEXT: str
    HUMANITIX_API: str
    ...
    RENDER_TIX_CHROMEDRIVER_VERSION: str
    RENDER_TIX_MAXHEALTH_VAR_NAME: str
    OPENAI_API_KEY: str
    OPENAI_ORG_ID: str
    ...
    SUMMARISER_VAR_REASONING_EFFORT: str
    ...
    SUMMARISER_THREAD_ID: int | None = None
